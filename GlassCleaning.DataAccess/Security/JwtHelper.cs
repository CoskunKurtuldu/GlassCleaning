...
namespace GlassCleaning.DataAccess.Security
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var signInCredential = SigningCredentialsHelper.CreateSigningCredentials(securityKey);
            var jwt = CreateJwtSecurityToken(_tokenOptions, user, signInCredential, operationClaims);
